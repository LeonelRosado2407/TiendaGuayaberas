              ...
              <div class="flex flex-wrap items-end justify-between -m-2">
                ...
                <div class="w-full sm:w-auto p-2">
                  <button class="group relative font-heading py-2 px-3.5 font-medium text-base text-gray-50 border border-gray-50 hover:border-gray-400 overflow-hidden rounded">
                    ...
                    <p class="relative z-10 group-hover:text-black">Quitar del carrito</p>
                  </button>
                </div>
              </div>
            </div>
          ...
          <div class="w-full">
            <div class="p-6">
              <div class="flex flex-wrap items-center justify-center -m-2">
                <div class="w-full p-2 sm:flex-1">
                  <h3 class="mb-1 font-heading font-bold text-lg text-white">Ingresa el informacion de tu tarjeta</h3>
                </div>
                <div class="w-full sm:w-auto p-2">
                <form class="max-w-sm mx-auto">
                    <div class="mb-6">
                        <label for="large-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre Completo</label>
                    ...
                    <button class="group relative font-heading py-2 px-3.5 font-medium text-base text-gray-50 border border-gray-50 hover:border-gray-400 overflow-hidden rounded">
                    <div class="absolute top-0 left-0 transform -translate-y-full group-hover:-translate-y-0 h-full w-full transition ease-in-out duration-500 bg-white"></div>
                    <p class="relative z-10 group-hover:text-black">Comprar</p>
                    </button>
                </form>
                </div>
              </div>

...
<section class="py-8">
    <div class="w-full px-4">
        <ul class="flex flex-wrap items-center mb-16">
            ...
            <li>
                <a class="text-sm font-medium text-indigo-500 hover:text-indigo-600" href="#">Listado de Productos</a>
            </li>
        </ul>
    </div>
        ...
        <table class="table-auto w-full">
          <thead>
            <tr class="text-xs text-gray-500 text-left">
                <th class="pl-6 pb-3 font-medium">Producto ID</th>
                <th class="pb-3 font-medium">Imagen</th>
                <th class="pb-3 font-medium">Nombre Producto</th>
                <th class="pb-3 font-medium">Precio</th>
                <th class="pb-3 font-medium">Talla</th>

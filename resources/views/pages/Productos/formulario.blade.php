      ...
      <div class="p-8 bg-gray-200 rounded-xl">
        <div class="flex flex-wrap items-center justify-between -mx-4 mb-8 pb-6 border-b border-gray-400 border-opacity-20">
          <div class="w-full sm:w-auto px-4 mb-6 sm:mb-0">
            <h4 class="text-2xl font-bold tracking-wide text-gray-900 mb-1">Agregar Producto</h4>
          </div>
          <div class="w-full sm:w-auto px-4">
            <div>
              <a class="inline-block py-2 px-4 mr-3 text-xs text-center font-semibold leading-normal text-gray-400 bg-gray-600 hover:bg-gray-700 rounded-lg transition duration-200" href="{{route('productos.index')}}">Cancelar</a>
              <button 
              class="inline-block py-2 px-4 text-xs text-center font-semibold leading-normal text-blue-50 bg-blue-500 hover:bg-blue-600 rounded-lg transition duration-200" 
              type="submit"
              >Guardar</button>
            </div>
          </div>
          ...
          <div class="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b border-gray-700 border-opacity-20">
            <div class="w-full sm:w-1/3 px-4 mb-4 sm:mb-0">
              <span class="text-sm font-medium text-gray-900">Nombre del Producto</span>
            </div>
            <div class="w-full sm:w-2/3 px-4">
              <div class="max-w-xl">
                <input 
                  class="block py-4 px-3 w-full text-sm text-gray-800 placeholder-gray-800 font-medium outline-none bg-transparent border border-gray-700 hover:bg-gray-400   focus:border-green-500 rounded-lg" 
                  id="formInput1-1" 
                  type="text" 
                  placeholder="Guayabera"
                  name="nombre">
              </div>
            </div>
          </div>
          ...
          <div class="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b border-gray-700 border-opacity-20">
            <div class="w-full sm:w-1/3 px-4 mb-4 sm:mb-0">
              <span class="text-sm font-medium text-gray-900">Descripción</span>
            </div>
            <div class="w-full sm:w-2/3 px-4">
              <div class="max-w-xl">
                <input 
          ...
          <div class="flex flex-wrap items-start -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
            <div class="w-full sm:w-1/3 px-4 mb-6 sm:mb-0">
              <span class="block text-sm font-medium text-gray-900">Foto del Producto</span>
            </div>
            <div class="w-full sm:w-2/3 px-4">
              <div class="flex flex-wrap sm:flex-nowrap max-w-xl">
                <div class="flex-shrink-0 w-40 h-40 mb-4 mr-4 rounded-full">
                  <img src="{{asset('img/default.png')}}" alt="">
                </div>
                <div class="w-full py-8 px-4 text-center border-dashed border border-gray-700 hover:border-gray-900 focus:border-green-500 rounded-lg">
                  <div class="relative group h-14 w-14 mx-auto mb-4">
                    ...
                    <input class="absolute top-0 left-0 h-14 w-14 opacity-0" id="formInput1-4" type="file" name="imgProducto">
                  </div>
                  <p class="font-semibold leading-normal mb-1">
                    <span class="text-blue-500">Click to upload a file</span>
                    <span class="text-gray-900">or drag and drop</span>
                  </p>
                  <span class="text-xs text-gray-900 font-semibold">PNG, JPG, GIF or up to 10MB</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
            <div class="w-full sm:w-1/3 px-4 mb-4 sm:mb-0">
              <span class="text-sm font-medium text-gray-900">Talla</span>
            </div>
            <div class="w-full sm:w-2/3 px-4">
              <div class="max-w-xl">
                <div class="relative block px-3 w-full text-sm text-gray-900 placeholder-gray-900 font-medium border border-gray-700 hover:border-gray-900 focus-within:border-green-500 rounded-lg">
                  ...
                  <select class="w-full py-4 appearance-none bg-transparent outline-none" id="formInput1-6" name="talla">
                    <option class="bg-gray-200" value="CH">CH</option>
                    <option class="bg-gray-200" value="M">M</option>
                    <option class="bg-gray-200" value="G">G</option>
                    <option class="bg-gray-200" value="XG">XG</option>
                  </select>
                </div>
              </div>
            </div>

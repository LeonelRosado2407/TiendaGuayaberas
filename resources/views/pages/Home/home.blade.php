  ...
  <div class="flex flex-wrap p-10 -m-4">
    <div class="w-full lg:w-5/12 p-4">
      <div class="py-18">
        ...
        <div class="flex flex-wrap gap-4"><a href="{{route('carrito')}}" class="bg-gray-900 rounded-full hover:bg-gray-800 focus:ring-4 focus:ring-gray-200 text-white text-sm font-semibold px-8 h-12 inline-flex items-center transition duration-200">Comprar ahora</a><a href="{{route('listaproducto')}}" class="bg-white border border-gray-200 rounded-full hover:bg-gray-50 focus:ring-4 focus:ring-gray-200 text-sm font-semibold px-8 h-12 inline-flex items-center transition duration-200">Ver productos disponibles</a></div>
      </div>
    </div>
    <div class="w-full lg:w-7/12 p-4">
      <div class="flex flex-wrap -m-4">
        <div class="w-full sm:w-8/12 p-4">
          <a href="#" class="group">
            <div class="relative overflow-hidden rounded-2xl" style="height:550px;">
              ...
              <img class="absolute left-1/2 top-1/2 transform -translate-y-1/2 -translate-x-1/2" src="" alt="">
            </div>
          </a>
        </div>
        <div class="w-1/2 sm:w-2/12 p-4">
          <a href="#" class="group">
            <div class="relative overflow-hidden rounded-2xl" style="height:550px;">
              <img class="rounded-2xl object-cover w-full h-full transform group-hover:scale-105 transition duration-200" src="img/traje.jpg" alt="">
              <div class="absolute left-1/2 bottom-32 transform -translate-x-1/2">
                <h2 class="font-heading text-5xl uppercase text-white text-center transform -rotate-90 whitespace-nowrap">#Trending 2024</h2>
              </div>
            </div>
          </a>
        </div>
        <div class="w-1/2 sm:w-2/12 p-4">
          <a href="#" class="group">
            <div class="relative overflow-hidden rounded-2xl" style="height:550px;">
              <img class="rounded-2xl object-cover w-full h-full transform group-hover:scale-105 transition duration-200" src="img/foto.jpg" alt="">
              <div class="absolute left-1/2 bottom-32 transform -translate-x-1/2">
                <h2 class="font-heading text-5xl uppercase text-white text-center transform -rotate-90 whitespace-nowrap">#Trending 2024</h2>
              </div>
            </div>

...
<section class="overflow-hidden" x-data="{ mobileNavOpen: false }">
  <div class="bg-black py-1 px-2">
    <p class="text-white text-center">Las mejoras guayaberas del estado de Yucatán</p>
  </div>
  <div class="flex flex-wrap p-10 -m-4">
    <div class="w-full lg:w-5/12 p-4">
      <div class="py-18">
        ...
        <h1 class="font-heading uppercase text-8xl max-w-lg mb-6">Guaraberas yucatecas</h1>
    ...
    <div class="w-full lg:w-7/12 p-4">
      <div class="flex flex-wrap -m-4">
          ...
          <a href="#" class="group">
            <div class="relative overflow-hidden rounded-2xl" style="height:550px;">
              ...
              <div class="absolute w-full bottom-6">
                <h2 class="font-heading text-6xl uppercase text-white text-center">t-shirt woman</h2>
              </div>
            </div>
          </a>
        </div>
        <div class="w-1/2 sm:w-2/12 p-4">
          <a href="#" class="group">
            <div class="relative overflow-hidden rounded-2xl" style="height:550px;">
              <img class="rounded-2xl object-cover w-full h-full transform group-hover:scale-105 transition duration-200" src="shopky-assets/headers/woman-picture2.png" alt="">
